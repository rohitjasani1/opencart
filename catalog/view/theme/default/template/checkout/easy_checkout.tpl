...
<div class="container">        
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> checkout-new"> 
     <h2><?php echo $heading_title; ?></h2>
      
		
	
		<div class="row box checkout_form box-container clearfix ">
		    <div class="col-md-4 register_block one-half one-half-left">
			<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
			   ...
			   <?php echo $content_top; ?>
                           <p class="well login-checkout"><?php //echo $text_returning_customer; ?> &nbsp;<a onclick="$(this).parent().parent().find('.login-checkout a').removeClass('active'); jQuery('.register-form').hide();jQuery('.login-form').show();" class="recustomer-btn"><input type="radio" name="register" onclick="jQuery('.register-form').show()" value="0"><i></i><?php echo $text_i_am_returning_customer; ?></a></p>
                           <p class="well login-checkout"><?php //echo $text_returning_customer; ?> &nbsp;<a onclick="$(this).parent().parent().find('.login-checkout a').removeClass('active');jQuery('.login-form').hide();jQuery('.register-form').show();" class="recustomer-btn active"><input type="radio" name="register" onclick="jQuery('.register-form').show()" value="1" checked><i></i>Register Account</a></p>
				...
				<div class="form-group col-md-4 forlog-btn">
                                    <p><a href="<?php echo $forgotten; ?>" class="forpassword"><?php echo $text_forgotten; ?></a></p>
				    <input type="button" value="<?php echo $button_login; ?>" id="button-login" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" class="btn btn-login btn-yellow btn-yellow-small" />
				</div>
			      </form>
			    </div>
			</div>
...
<!--				  <div class="form-group col-md-6" >
			...
			<div class="shiptobilling clearfix">
                                    <h3> <?php if (isset($customer_id)) {?><?php echo $text_checkout_shipping_address; ?> <?php } ?>
					<?php if (!isset($customer_id)) {?>
...
<!--				<div class="register-form">
		    ...
		    <div class="col-md-4 one-half one-half-right">
		    	 	<!--col-md-4 shopping-cart-->
                                        <div class=""> <div class="your_order">
		 ...
		 <?php if ($shipping_required) { ?>
				...
				<?php } ?>
					...
					<p><?php $payment; ?></p>
					   <?php } else { ?>
					    <input type="button" class="btn-yellow btn-yellow-small checkbox-btn pull-right" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" id="button-register" value="<?php echo $heading_title;?>">
					    <?php }?></div>
