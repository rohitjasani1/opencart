...
class ControllerCheckoutCheckout extends Controller { 
	...
	{ //echo "<pre>"; print_r($this->session->data); echo "</pre>";
	 //unset($this->session->data['coupon']); die();
	...
	public function guest_validate() {
		...
		$this->load->language('checkout/checkout');
			...
			if (!$json) {
				...
				if (isset($this->request->post['telephone']) && ((utf8_strlen($this->request->post['telephone']) < 10) || (utf8_strlen($this->request->post['telephone']) > 10 || preg_match("/^[0-9]+$/", $this->request->post['telephone']) === 0))) {
				$json['error']['telephone'] = $this->language->get('error_telephone');
				}
