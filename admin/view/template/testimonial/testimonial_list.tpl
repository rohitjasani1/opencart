...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><i class="fa fa-comments"></i> <?php echo $heading_title; ?><div class="dev-name"></h1>
      <ul class="breadcrumb">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left"><?php if ($sort == 'r.author') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'r.city') { ?>
              ...
              <tbody>
				...
				?>
                <tr>
                  <td class="text-center"><?php if (in_array($review['testimonial_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['testimonial_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['testimonial_id']; ?>" />
                    <?php } ?></td>
				<td class="text-center"><?php if ($review['image']) { ?>
                    <img src="<?php echo $review['image']; ?>" alt="<?php echo $review['author']; ?>" class="img-thumbnail" />
                    <?php } else { ?>
				  ...
				  <td class="text-center"><?php echo $review['text']; ?></td>
