      ...
      <div class="panel-body">
		...
		<div class="row">
		 ...
		 <div class="col-lg-3 col-md-3 col-sm-6" style = "width:20% !important;">
			  <div class="tile">
				  ...
				  <div class="tile-body" align="center"><a href = 'http://oc20.onjection.com/admin/index.php?route=catalog/pincode/getlist&amp;token=DLgmIETwC99ZplesGpq9W83NncPD9bVd'><i class="fa fa-list" style = "font-size: 101px; !important;"></i></a></div>
				  <div class="tile-footer"><a href="http://oc20.onjection.com/admin/index.php?route=catalog/pincode/getlist&amp;token=DLgmIETwC99ZplesGpq9W83NncPD9bVd">List Pincode...</a></div>
			  </div>
		</div>
        <div class="col-lg-3 col-md-3 col-sm-6" style = "width:20% !important;">
			<div class="tile">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6" style = "width:20% !important;">
			<div class="tile">
				...
				<div class="tile-body" align="center"><a href = 'http://oc20.onjection.com/admin/index.php?route=catalog/pincode/delivery_getlist&amp;token=DLgmIETwC99ZplesGpq9W83NncPD9bVd'><i class="fa fa-list" style = "font-size: 101px; !important;"></i></a></div>
				<div class="tile-footer"><a href = 'http://oc20.onjection.com/admin/index.php?route=catalog/pincode/delivery_getlist&amp;token=DLgmIETwC99ZplesGpq9W83NncPD9bVd'>Delivery Options List...</a></div>
			</div>
		</div>
		 <div class="col-lg-3 col-md-3 col-sm-6" style = "width:20% !important;">
			  <div class="tile">
	...
	<!--<?php if(isset($_GET['allpin'])){ ?>
		...
		?>
			...
			<tr align = "center">
				...
				<td class="left"><a title = "EDIT"  href = "?route=common/pincode&token=<?php echo $this->request->get['token']?>&editpin=<?php echo $pincode['id'];?>"><font color = 'blue'><img src = "../image/pincode/edit.png" /></font></a></td>
			</tr>
	<?php
			}
			}
