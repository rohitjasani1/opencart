...
<div id="content">
  ...
  <div class="container-fluid">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input readonly type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" onkeyup="seoKeyword(this.value); " />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea readonly name="product_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="model" value="<?php echo $model; ?>" placeholder="<?php echo $entry_model; ?>" id="input-model" class="form-control" />
                  <?php if ($error_model) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="sku" value="<?php echo $sku; ?>" placeholder="<?php echo $entry_sku; ?>" id="input-sku" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="upc" value="<?php echo $upc; ?>" placeholder="<?php echo $entry_upc; ?>" id="input-upc" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="ean" value="<?php echo $ean; ?>" placeholder="<?php echo $entry_ean; ?>" id="input-ean" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="jan" value="<?php echo $jan; ?>" placeholder="<?php echo $entry_jan; ?>" id="input-jan" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="isbn" value="<?php echo $isbn; ?>" placeholder="<?php echo $entry_isbn; ?>" id="input-isbn" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="mpn" value="<?php echo $mpn; ?>" placeholder="<?php echo $entry_mpn; ?>" id="input-mpn" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-no_follow"><?php echo $entry_no_follow; ?></label>
                <div class="col-sm-10">
                  <input type="text"  name="no_follow" value="<?php echo $no_follow; ?>" placeholder="<?php echo $entry_no_follow; ?>" id="input-no_follow" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-alt"><?php echo $entry_alt; ?></label>
                <div class="col-sm-10">
                  <input type="text" readonly name="alt" value="<?php echo $alt; ?>" placeholder="<?php echo $entry_alt; ?>" id="input-alt" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <?php if(isset($product_specials) && !empty($product_specials)){  ?>
              <?php foreach ($product_specials as $product_special) { ?>
              <tr id="special-row0">
   <td class="text-left"><select readonly name="product_special[0][customer_group_id]" class="form-control" style="display:none;">
    <?php foreach ($customer_groups as $customer_group) { ?>
   <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo addslashes($customer_group['name']); ?></option>
    <?php } ?>
   </select></td>
   <td class="text-right" style="display:none;"><input type="text" name="product_special[0][priority]" style="display:none;" value="" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>
			
			<div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo 'Special Price Percentage'; ?></label>
                <div class="col-sm-10">
	                    			<input type="text" readonly name="product_special[0][percentage]" value="<?php echo((1 - $product_special['price'] * (1/$price)) * 100); ?>" size="2" placeholder="%" onkeyup="calcPrice('special', 0)" class="form-control"/></td>
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo 'Special Price'; ?></label>
                <div class="col-sm-10">
                  <input type="text" readonly name="product_special[0][price]" value="<?php echo $product_special['price']; ?>" placeholder="<?php echo 'Special Price'; ?>" id="input-price" class="form-control" />
	...
	<!--<td class="text-right"><input type="text" name="product_special[0][price]" value="" placeholder="<?php echo $entry_price; ?>" class="form-control" /></td>-->
    
    
    
    <td class="text-left" style="width: 20%;"><div class="input-group date" style="display:none;"><input type="text" readonly name="product_special[0][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
	<td class="text-left" style="width: 20%;"><div class="input-group date" style="display:none;"><input type="text" readonly name="product_special[0][date_end]" value="" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
	</tr>
   ...
   <td class="text-right" style="display:none;"><input readonly type="text" name="product_special[0][priority]" style="display:none;" value="" placeholder="<?php echo $entry_priority; ?>" class="form-control" /></td>
		
			<div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo 'Special Price Percentage'; ?></label>
                <div class="col-sm-10">
	                    			<td class="text-right"><input readonly type="text" name="product_special[0][percentage]" value="" size="2" placeholder="%" onkeyup="calcPrice('special', 0)" class="form-control"/></td>
                </div>
              </div>
			...
			<div class="form-group">
                <label class="col-sm-2 control-label" for="input-price"><?php echo 'Special Price'; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="product_special[0][price]" readonly value="" placeholder="<?php echo 'Special Price'; ?>" id="input-price" class="form-control" />
                <?php if ($error_special) { ?>
                  <div class="text-danger"><?php echo $error_special; ?></div>
                  <?php } ?>
    ...
    <td class="text-left" style="width: 20%;"><div class="input-group date" style="display:none;"><input readonly type="text" name="product_special[0][date_start]" value="" placeholder="<?php echo $entry_date_start; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
	<td class="text-left" style="width: 20%;"><div class="input-group date" style="display:none;"><input readonly type="text" name="product_special[0][date_end]" value="" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></td>
	</tr>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select readonly name="tax_class_id" id="input-tax-class" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="quantity" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input type="text" readonly name="minimum" value="<?php echo $minimum; ?>" placeholder="<?php echo $entry_minimum; ?>" id="input-minimum" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                <label class="col-sm-2 control-label" for="input-subtract"><?php echo $entry_subtract; ?></label>
                <div class="col-sm-10" style="display:none;">
                  <select name="subtract" readonly id="input-subtract" class="form-control">
                    <?php if ($subtract) { ?>
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <select readonly name="stock_status_id" id="input-stock-status" class="form-control">
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($shipping) { ?>
                    <input readonly type="radio" name="shipping" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input readonly type="radio" name="shipping" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shipping) { ?>
                    <input readonly type="radio" name="shipping" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input readonly type="radio" name="shipping" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input readonly type="text" name="date_available" value="<?php echo $date_available; ?>" placeholder="<?php echo $entry_date_available; ?>" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control" />
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-sm-4">
                      <input readonly type="text" name="length" value="<?php echo $length; ?>" placeholder="<?php echo $entry_length; ?>" id="input-length" class="form-control" />
                    </div>
                    <div class="col-sm-4">
                      <input readonly type="text" name="width" value="<?php echo $width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-width" class="form-control" />
                    </div>
                    <div class="col-sm-4">
                      <input readonly type="text" name="height" value="<?php echo $height; ?>" placeholder="<?php echo $entry_height; ?>" id="input-height" class="form-control" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <select readonly name="length_class_id" id="input-length-class" class="form-control">
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="weight" value="<?php echo $weight; ?>" placeholder="<?php echo $entry_weight; ?>" id="input-weight" class="form-control" />
                </div>
              </div>
              <div class="form-group" style="display:none;">
                <label class="col-sm-2 control-label" for="input-weight-class"><?php echo $entry_weight_class; ?></label>
                <div class="col-sm-10">
                  <select readonly name="weight_class_id" id="input-weight-class" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select readonly name="status" id="input-status" class="form-control">
                    <?php if ($status) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="sort_order" value="<?php echo $sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-links">
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="manufacturer" value="<?php echo $manufacturer; ?>" placeholder="<?php echo $entry_manufacturer; ?>" id="input-manufacturer" class="form-control" />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="category" value="" placeholder="<?php echo $entry_category; ?>" id="input-category" class="form-control" />
                  <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_categories as $product_category) { ?>
                    <div id="product-category<?php echo $product_category['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_category['name']; ?>
                      <input readonly type="hidden" name="product_category[]" value="<?php echo $product_category['category_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-filter" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="product-filter<?php echo $product_filter['filter_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_filter['name']; ?>
                      <input readonly type="hidden" name="product_filter[]" value="<?php echo $product_filter['filter_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
                  ...
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    <div class="checkbox">
                      <label>
                        ...
                        <input readonly type="checkbox" name="product_store[]" value="0" checked="checked" />
                        <?php echo $text_default; ?>
                        <?php } else { ?>
                        <input readonly type="checkbox" name="product_store[]" value="0" />
                        <?php echo $text_default; ?>
                        <?php } ?>
                      </label>
                    </div>
                    ...
                    <div class="checkbox">
                      <label>
                        ...
                        <input readonly type="checkbox" name="product_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                        <?php echo $store['name']; ?>
                        <?php } else { ?>
                        <input readonly type="checkbox" name="product_store[]" value="<?php echo $store['store_id']; ?>" />
                        <?php echo $store['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
              ...
              <div class="form-group" style="display:none;">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="download" value="" placeholder="<?php echo $entry_download; ?>" id="input-download" class="form-control" />
                  <div id="product-download" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="product-download<?php echo $product_download['download_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_download['name']; ?>
                      <input readonly type="hidden" name="product_download[]" value="<?php echo $product_download['download_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input readonly type="text" name="related" value="" placeholder="<?php echo $entry_related; ?>" id="input-related" class="form-control" />
                  <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($product_relateds as $product_related) { ?>
                    <div id="product-related<?php echo $product_related['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_related['name']; ?>
                      <input readonly type="hidden" name="product_related[]" value="<?php echo $product_related['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
                  ...
                  <tbody>
                    ...
                    <tr id="attribute-row<?php echo $attribute_row; ?>">
                      <td class="text-left" style="width: 40%;"><input type="text" name="product_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $product_attribute['name']; ?>" placeholder="<?php echo $entry_attribute; ?>" class="form-control" />
                        <input readonly type="hidden" name="product_attribute[<?php echo $attribute_row; ?>][attribute_id]" value="<?php echo $product_attribute['attribute_id']; ?>" /></td>
                      <td class="text-left"><?php foreach ($languages as $language) { ?>
                        <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                          <textarea readonly name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"><?php echo isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['text'] : ''; ?></textarea>
                        </div>
                        <?php } ?></td>
              ...
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="option">
                    ...
                    <?php } ?>
                    <li>
                      <input readonly type="text" name="option" value="" placeholder="<?php echo $entry_option; ?>" id="input-option" class="form-control" />
                    </li>
                  </ul>
                </div>
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input readonly type="text" name="product_option[<?php echo $option_row; ?>][value]" value="<?php echo $product_option['value']; ?>" placeholder="<?php echo $entry_option_value; ?>" id="input-value<?php echo $option_row; ?>" class="form-control" />
                        </div>
                      </div>
                      <?php } ?>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                        <div class="col-sm-10">
                          <textarea readonly name="product_option[<?php echo $option_row; ?>][value]" rows="5" placeholder="<?php echo $entry_option_value; ?>" id="input-value<?php echo $option_row; ?>" class="form-control"><?php echo $product_option['value']; ?></textarea>
                        </div>
                      </div>
                      <?php } ?>
...
$('input[name=\'sku\']').val($('input[name=\'model\']').val());
});
...
--></script>
        ...
        <script type="text/javascript"><!--
          function seoKeyword(name_value){
					var str=name_value.toLowerCase().replace(/ +/g,'-').replace(/[0-9]/g,'').replace(/[^a-z0-9-_]/g,'').trim();
