...
$data['config_telephone'] = $this->config->get('config_telephone');
		...
		if ($product_info) {
			...
			$data['lastimage'] =  $this->model_tool_image->resize('catalog/2.jpg', $this->config->get($this->config->get('config_theme') . '_image_additional_width'), $this->config->get($this->config->get('config_theme') . '_image_additional_height'));
			$data['lastimagebig'] =  $this->model_tool_image->resize('catalog/2.jpg', $this->config->get($this->config->get('config_theme') . '_image_popup_width'), $this->config->get($this->config->get('config_theme') . '_image_popup_height'));
        	...
        	if(isset($_POST['pincode'])){
        		...
        		if(isset($pin['id'])){
        			...
        			if($service == '1'){
        				...
        				echo "<font color = '".$text_color."'>".$message_cod."</font></font><br />";
        				//echo "<img src='image/pincode/check.png' width='15' height='15'>Delivery: <font color = '".$text_color."'>".$pin['delivery_time']."</font></font><br /></div>";
        				...
        				//$_SESSION['pin_check_delivery'] = "<img src='image/pincode/check.png' width='15' height='15'>Delivery: <font color = '".$text_color."'>".$pin['delivery_time']."</font>";
        			}
        			else if($service == '0'){
        				echo "<div class=''><img src='image/pincode/l.png' width='15' height='15'>Delivery option for: ".$_SESSION['pincode']."&nbsp;&nbsp;<form style='display: inline;'><input type = 'button'  onClick = 'showform1()' value='Change' class='pin-check' /></form><br />";
        				echo "<font color = '".$text_color."'>".$message_pre."</font><br />";
        				//echo "<img src='image/pincode/check.png' width='15' height='15'>Delivery: <font color = '".$text_color."'>".$pin['delivery_time']."</font></font><br /></div>";
